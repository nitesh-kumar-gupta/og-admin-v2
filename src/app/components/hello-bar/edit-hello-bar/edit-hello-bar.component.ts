...
export class EditHelloBarComponent implements OnInit,AfterViewInit {
  ...
  constructor(private _script: ScriptService,private adminService:AdminService,
    private planService: PlanService,private companyService : CompanyService
  ) { }
